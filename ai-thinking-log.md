Prompt:
Estoy trabajando en un proyecto de Sistema de Seguimiento de Talento (ATS) llamado "LTI". El proyecto está desarrollado completamente usando TypeScript, dispondremos de un FrontEnd usando REACT y un BackEnd que nos generará las API necesarias, utilizaremos Node, Express y utilizaremos PostgreSQL como base de datos. Seguimos los principios de Diseño Dirigido por el Dominio (DDD), Desarrollo Dirigido por Pruebas (TDD).
...
## Cuarto paso (GPT-4): Crear la lista de features a partir de las user stories del PRD

prompt:
Read the user stories in the document and create a list of features and then I want to choose one